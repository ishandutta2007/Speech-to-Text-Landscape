...
A curated list of modern Speech-to-Text (STT) technologies, services, models, and research.
...
| **Vosk** | Alpha Cephei | Portable, offline, lightweight (Android/iOS/Raspberry Pi). | [GitHub](https://github.com/alphacep/vosk-api) |
...
| **Gladia** | $0.61/hr (Async) | 10 hours/month (Recurring) | Multi-model engine; Diarization/Sentiment included. |
| **Speechmatics** | $0.24/hr (Pro) | 8 hours/month (Recurring) | High accuracy on accents; "Flow" voice agent. |
| **Google Cloud** | $0.016/min | 60 minutes/month | Chirp model; GCP ecosystem integration. |
| **AWS Transcribe** | $0.024/min | 60 mins/mo (12 months) | Call analytics; PII redaction. |
...
| :--- | :--- | :--- | :--- |
| **Wispr Flow** | Polished dictation & writing | $15/mo (Free tier avail) | [Link](https://www.flowvoice.ai/) |
...
| **M2S-AVSR** | Multi-view audio-visual fusion for noise robustness | [arXiv:2606.05440](https://arxiv.org/abs/2606.05440) |
...
These projects were once staples of the STT community but have largely been superseded by modern transformer-based models.
...
* [Reddit: r/LocalLLaMA (STT Discussion)](https://www.reddit.com/r/LocalLLaMA/)
...
<div align="center">
   <a href="https://www.star-history.com/?repos=ishandutta2007%2FSpeech-to-Text-Landscape&type=date&legend=bottom-right">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=ishandutta2007/Speech-to-Text-Landscape&type=date&theme=dark&legend=bottom-right" />
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=ishandutta2007/Speech-to-Text-Landscape&type=date&legend=bottom-right" />
      <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=ishandutta2007/Speech-to-Text-Landscape&type=date&legend=bottom-right" />
    </picture>
   </a>
</div>
